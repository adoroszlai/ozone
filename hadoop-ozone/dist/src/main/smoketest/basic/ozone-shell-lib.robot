...
Test key handling
    [arguments]     ${protocol}         ${server}       ${volume}
                    ...
                    Execute             rm -f ${TEMPDIR}/NOTICE.txt.1
                    Execute             ozone sh key get ${protocol}${server}/${volume}/bb1/key1 ${TEMPDIR}/NOTICE.txt.1
                    Execute             diff -q /opt/hadoop/NOTICE.txt ${TEMPDIR}/NOTICE.txt.1

                    Execute             ozone sh key put -t RATIS ${protocol}${server}/${volume}/bb1/key1_RATIS /opt/hadoop/NOTICE.txt
                    Execute             rm -f ${TEMPDIR}/key1_RATIS
                    Execute             ozone sh key get ${protocol}${server}/${volume}/bb1/key1_RATIS ${TEMPDIR}/key1_RATIS
                    Execute             diff -q /opt/hadoop/NOTICE.txt ${TEMPDIR}/key1_RATIS
    ${result} =     Execute             ozone sh key info ${protocol}${server}/${volume}/bb1/key1_RATIS | jq -r '. | select(.name=="key1_RATIS")'
                    ...
                    Execute             rm -f ${TEMPDIR}/key1-copy
                    Execute             ozone sh key get ${protocol}${server}/${volume}/bb1/key1-copy ${TEMPDIR}/key1-copy
                    Execute             diff -q /opt/hadoop/NOTICE.txt ${TEMPDIR}/key1-copy
                    Execute             ozone sh key delete ${protocol}${server}/${volume}/bb1/key1-copy

    ${result} =     Execute And Ignore Error    ozone sh key get ${protocol}${server}/${volume}/bb1/key1 ${TEMPDIR}/NOTICE.txt.1
                    Should Contain      ${result}       NOTICE.txt.1 exists
    ${result} =     Execute             ozone sh key get --force ${protocol}${server}/${volume}/bb1/key1 ${TEMPDIR}/NOTICE.txt.1
