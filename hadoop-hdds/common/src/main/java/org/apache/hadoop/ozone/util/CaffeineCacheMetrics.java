 ...
 */
public final class CaffeineCacheMetrics implements MetricsSource {

  public static final String SOURCE_NAME = CaffeineCacheMetrics.class.getSimpleName();

  private final Cache<?, ?> cache;
  private final String name;
  private final String sourceName;

  private CaffeineCacheMetrics(Cache<?, ?> cache, String name) {
    this.cache = cache;
    this.name = name;
    sourceName = SOURCE_NAME + "-" + name;
  }

  public static CaffeineCacheMetrics create(Cache<?, ?> cache, Object owner) {
    final String name = JavaUtils.getClassSimpleName(owner.getClass())
        + "@" + Integer.toHexString(owner.hashCode());
    return create(cache, name);
  }

  public static CaffeineCacheMetrics create(Cache<?, ?> cache, String name) {
    MetricsSystem ms = DefaultMetricsSystem.instance();
    CaffeineCacheMetrics source = new CaffeineCacheMetrics(cache, name);
  ...
  public void getMetrics(MetricsCollector collector, boolean all) {
    ...
    recordBuilder
        .addGauge(CacheMetricsInfo.Size, cache.estimatedSize())
